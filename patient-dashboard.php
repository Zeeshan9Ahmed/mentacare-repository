<?php include_once('header.php') ;
	...
	$appointments = "select appointments.date , appointments.time,appointments.amount,appointments.status, users.id , users.name  from appointments INNER JOIN users on appointments.doctor_id = users.id where patient_id =
